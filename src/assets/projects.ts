export const projects = [
  ...
  },
  {
    ...
    title: 'Nostra Pizza',
    description:
      "ackend for Nostra Pizza is built with NestJS, PostgreSQL, and TypeORM. It handles product and order management with robust authentication. Orders from users are sent directly to the owner's Gmail account. Product images are uploaded and stored using Cloudinary. The backend is documented with Swagger for easy API interaction. It's optimized for scalability and performance, ensuring smooth operation across devices for both customers and administrators.",
    techstack: 'Nest.js, TypeScript, PostgreSQL, TypeORM, Nodemailer, Swagger, Render, Cloudinary.',
    role: 'Back-End Developer & Product Creator.',
    liveUrl: 'https://pizza-nest-pg.onrender.com/api/docs',
    githubUrl: 'https://github.com/Yevhenns/pizza-nest-pg.git',
  },
  {
    id: 3,
